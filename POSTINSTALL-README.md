...
However, there are certain exceptions. A few common usecases are if you need support for Steam, play *any* games, or run an ocassional application in Wine... you'll likely want to keep support for 32-bit programs. If that is the case, answer `Y`.
