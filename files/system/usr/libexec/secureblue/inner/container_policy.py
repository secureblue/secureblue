...
"""Sandbox script for default_container_policy.py that conducts prilidged file operations"""
...
def main() -> int:
    ...
    valid_arguments = ["normal", "multi-save", "deactivate"]
    ...
    match argv[1]:
        ...
        case "deactivate":
            os.remove(SYSTEM_POLICY_FILE)
            os.rename(f"{SYSTEM_POLICY_FILE}.old", SYSTEM_POLICY_FILE)
