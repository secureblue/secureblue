...
- Anything related to "degoogling" chromium. For example, we will not be replacing hardened-chromium with Brave or ungoogled-chromium. Both of them make changes that sacrifice security for "privacy" and "better adblocking", such as enabling MV2, which gives extensions unnecessary permissions.
