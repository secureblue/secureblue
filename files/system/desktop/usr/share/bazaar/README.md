...
Firefox-based flatpaks simply throw up their hands in defeat and [disable much of the Firefox internal sandbox](https://bugzilla.mozilla.org/show_bug.cgi?id=1756236). Technically, the Firefox codebase has a warning about this, however, [they intentionally disable the warning](https://hg-edge.mozilla.org/releases/mozilla-beta/rev/509d4746f2d6) in the official Flatpak. On top of all this, the Firefox internal sandbox itself is known to be weaker than Chromium's sandbox. The situation has slightly improved in the past few years, primarily by [switching to Wayland](https://www.firefox.com/en-US/firefox/121.0/releasenotes#note-789921) and implementing a [properly sandboxed audio service](https://github.com/mozilla/cubeb), but there are still various unresolved issues. While [madaidan's criticism](https://madaidans-insecurities.github.io/firefox-chromium.html) is fairly old, much of the information within is still correct, and [Chromium has only continued to pull ahead](https://www.chromium.org/Home/chromium-security/quarterly-updates/), so it is still worth reading for more information.
